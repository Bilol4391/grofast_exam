                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      child: const Center(child: Text("Fast Shipment to your home!", textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.w700,fontSize: 28, color: Color(0xff194B38)),)),
                    ),
                    Container(
                      width: 280,
                      height: 73,
